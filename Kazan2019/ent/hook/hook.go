...
// The AssetPhotoFunc type is an adapter to allow the use of ordinary
// function as AssetPhoto mutator.
type AssetPhotoFunc func(context.Context, *ent.AssetPhotoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AssetPhotoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AssetPhotoMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AssetPhotoMutation", m)
}

// The AssetTransferLogFunc type is an adapter to allow the use of ordinary
// function as AssetTransferLog mutator.
type AssetTransferLogFunc func(context.Context, *ent.AssetTransferLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AssetTransferLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AssetTransferLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AssetTransferLogMutation", m)
}
...
// The DepartmentLocationFunc type is an adapter to allow the use of ordinary
// function as DepartmentLocation mutator.
type DepartmentLocationFunc func(context.Context, *ent.DepartmentLocationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DepartmentLocationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DepartmentLocationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DepartmentLocationMutation", m)
}

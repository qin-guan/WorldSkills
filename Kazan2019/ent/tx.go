...
func (tx *Tx) init() {
	...
	tx.AssetPhoto = NewAssetPhotoClient(tx.config)
	tx.AssetTransferLog = NewAssetTransferLogClient(tx.config)
	tx.Department = NewDepartmentClient(tx.config)
	tx.DepartmentLocation = NewDepartmentLocationClient(tx.config)
